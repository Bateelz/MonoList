                            ...
                            <div class="d-flex flex-column">
                                <div class="mb-4 mb-md-5">
                                    <a href="index" class="d-block auth-logo">
                                        <img src="{{ asset('/assets/images/monolist_red_full_02.png') }}" alt=""
                                ...
                                <div class="mt-4">
                                    <form class="form-horizontal" method="post"
                                        action="{{ route('forget.updatepassword') }}">
                                        @csrf
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" class="form-control @error('email') is-invalid @enderror"
                                                value="{{ old('email') }}" placeholder="New Password" autofocus>
                                            @error('email')
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" class="form-control @error('email') is-invalid @enderror"
                                                value="{{ old('email') }}" placeholder="Confirm Password" autofocus>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p>You Remember It ? <a href="{{ url('login') }}"
