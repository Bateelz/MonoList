...
function makeid(a) {
  for (var t = "", e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", s = e.length, d = 0; d < a; d++) {
...
$(document).ready(function () {
  ...
  $("#NewtaskForm").validate({
    ...
    for ($("#taskassignee input[type=checkbox]:checked").each(function () {
      ...
      r = r + '<div class="avatar-group-item"><a href="#" class="d-inline-block" value="' + o[i] + '"><img src="' + n[i] + '" class="rounded-circle avatar-xs" alt=""></a></div>';
    }
